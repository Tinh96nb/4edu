						...
						<ul class="nav nav-pills nav-stacked">
							<li>
								<a role="button" data-toggle="collapse" href="#name">
									...
									<div class="text-content">{{ Auth::user()->username }}</div>
												...
												<ul>
													<li class="row">
														...
														<div class="col-md-6 col-sm-10 col-xs-12">
															<input type="text" name="username" class="form-control input-sm" placeholder="User Name" value="{{ Auth::user()->username }}">		
													...
													<li class="row">
														...
														<div class="col-md-6 col-sm-10 col-xs-12">
															<input type="text" name="fullname" class="form-control input-sm" placeholder="Tên đầy đủ" value="{{ Auth::user()->fullname }}">		
													...
													<li class="row">
														...
														<div class="col-md-6 col-sm-10 col-xs-12">
															<input type="text" name="email" class="form-control input-sm" placeholder="Email" value="{{ Auth::user()->email }}">
								...
								<li>
									<a role="button" data-toggle="collapse" href="#username">
										...
										<div class="text-content">{{ Auth::user()->fullname }}</div>
										<div class="text-edit"><i class="fa fa-pencil" aria-hidden="true"></i> Chỉnh sửa</div>
									</a>
								...
								<li>
									<a role="button" data-toggle="collapse" href="#contact">
										...
										<div class="text-content">{{ Auth::user()->email }}</div>
										<div class="text-edit"><i class="fa fa-pencil" aria-hidden="true"></i> Chỉnh sửa</div>
									</a>
